...
st.set_page_config(
    page_title="BengCreativeAI",
    page_icon="🤖",
    layout="wide",
    initial_sidebar_state="auto",
    menu_items={
        "Report a bug": "https://github.com/Khanh-BangPham",
        "About": "https://github.com/Khanh-BangPham BengCreativeAI\nSimply provide a topic or keyword for a video, and it will "
...
with title_col:
    st.title(f"BengCreative v{config.project_version}")
